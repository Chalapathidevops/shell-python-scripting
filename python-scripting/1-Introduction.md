## Python 
Python is a popular and versatile computer programming language that people use to give instructions to computers. It's known for being easy to read and write because it resembles the English language. Python is widely used in various fields, like web development, data analysis, and automation, to create software, solve problems, and make computers do tasks automatically. It's like a tool that helps you tell your computer what to do in a way that's understandable and efficient.

<ins>***Shell Vs Python***<ins>
